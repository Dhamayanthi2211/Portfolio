...
import Cert3 from "../assets/Certificates/40th-national-2024-pondichery.jpg";
...
export default function Certificate() {
  const certificates = [
    ...
    { title: "Merit State Thiruvurur 34th", date: "2023", image: Cert4 },
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 z-10">
        {certificates.map((cert, index) => (
          <div
            key={index}
            className="relative group bg-[#111] border border-gray-800 rounded-xl overflow-hidden shadow-[0_0_20px_#a855f7] hover:border-fuchsia-500 transition-all duration-500"
          >
